...
#include "TimeAttackVoloPawn.generated.h"
...
UCLASS(config=Game)
class ATimeAttackVoloPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	// Verify when the car has to respawn in the game.
	bool RespawnCheck();
...
private:
	...
	// Handle of the timer for the respawn time.
